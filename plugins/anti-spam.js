        ...
        if (isStickerSpam || isPhotoVideoSpam) {
            if (isBotAdmin && bot.restrict) {
                try {
                    ...
                    await conn.sendMessage(m.chat, {
                        text: `
⚡ 𝐙𝐘𝐍𝐎 𝚩𝚯𝐓 — ANTI-SPAM SYSTEM ⚡

🚨 ATTIVITÀ SOSPETTA RILEVATA
Utente rimosso per spam massivo.

🛡️ ZYNO SECURITY CORE ATTIVO
_Il sistema ha ripulito il gruppo._
`.trim()
                    });
